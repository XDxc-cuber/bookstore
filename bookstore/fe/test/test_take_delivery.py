...
class TestTakeDelivery:
    ...
    def pre_run_initialization(self):
        self.seller_id = "test_take_delivery_seller_id_{}".format(str(uuid.uuid1()))
        self.store_id = "test_take_delivery_store_id_{}".format(str(uuid.uuid1()))
        self.buyer_id = "test_take_delivery_buyer_id_{}".format(str(uuid.uuid1()))
